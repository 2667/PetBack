...
- (void)setStatus:(NSString *)string {
    ...
    if(string) {
        ...
        CGSize stringSize = [string  boundingRectWithSize:CGSizeMake(200, 300) options: NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName: self.stringLabel.font} context:nil].size;
...
- (UIView *)hudView {
    if(!hudView) {
		...
		hudView.backgroundColor = [UIColor colorWithRed:0.1 green:0.1 blue:0.1 alpha:0.6];
//        hudView.layer.borderWidth = 1.5f;
//        hudView.layer.borderColor = [[UIColor colorWithRed:0.37 green:0.77 blue:0.84 alpha:1] CGColor];
...
- (UILabel *)stringLabel {
    if (stringLabel == nil) {
		...
		stringLabel.textColor = [UIColor colorWithRed:1.00f green:1.00f blue:1.00f alpha:1];
...
- (UIActivityIndicatorView *)spinnerView {
    if (spinnerView == nil) {
		...
		spinnerView.bounds = CGRectMake(0, 0, 40, 40);
    }
